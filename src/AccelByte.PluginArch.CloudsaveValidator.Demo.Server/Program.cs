...
using Prometheus;
using AccelByte.PluginArch.CloudsaveValidator.Demo.Server.Services;

namespace AccelByte.PluginArch.CloudsaveValidator.Demo.Server
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            if (appServiceName == null)
                appServiceName = "extend-app-cloudsave-validator";
            else
                appServiceName = $"extend-app-cv-{appServiceName.Trim().ToLower()}";
            ...
            if (appResourceName == null)
                appResourceName = "CLOUDSAVEVALEXTENDAPP";
            ...
            app.MapGrpcService<CloudSaveValidatorService>();
